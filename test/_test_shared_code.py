...
def call_converter(
    converter: str, test_data_item: dict[str, Any], override_publisher: str = None
) -> List[dict[str, Any]]:
    ...
    if converter == "emon":
        return emon_to_timescale(messagebody, topic, publisher_to_send)
    elif converter == "glow":
        return glow_to_timescale(messagebody, topic, publisher_to_send)
    elif converter == "homie":
        return homie_to_timescale(messagebody, topic, publisher_to_send)
    else:
...
class Test_Converter_Methods:
    class Test_homie_to_timescale:
        def test_with_valid_json_for_mode(self):
